  ...
  <div class="card">
    <div class="additional">
      <div class="user-card">
        ...
        {/* <svg width="110" height="110" viewBox="0 0 250 250" xmlns={<Avatar src="https://joeschmoe.io/api/v1/random" />} role="img" aria-labelledby="title desc" class="center">
      ...
      <div class="more-info">
        ...
        <div class="stats">
          ...
          <div>
            <div class="title">Lương</div>
            <i class="fa fa-coffee"></i>
            <div class="value tiny">Thỏa thuận</div>
          </div>
        </div>
        <div class="bottom-button">
          <Link><Button className='detail-btn'>Xem chi tiết</Button></Link>
      </div>
      </div>
    </div>
    <div class="general">
      <h1>Tuyển intern</h1>
      <p>Description</p>
      {/* <span class="more"><Link to=''>Xem chi tiết</Link></span> */}
    </div>
  </div>
