...
import { Avatar, Button, Form, Input, InputNumber, message, Modal, Select, Tag } from "antd";
...
import { checkAddress, checkScale, checkWebsite, checkComName, checkMail, checkPhone, checkYear, checkManufacture } from "../../common/validation";
...
export const CompanyProfile = ()=>{
    ...
    async function updateManuCompany(){
        const url = serverURL + 'manu-company';
            const data = { id_company: account._id, id_manu_array: company.manufacture};
    ...
    const renderButtonGroup = ()=>{
        if(!isEdit){
            return (
                <Button type='submit' className='button edit-btn' onClick={handleEdit}>{company._id===-1?'Cập nhật':'Sửa'}</Button>
            )
        }else{
            return (
                <>
    ...
    function handleChangeComName(e) {
        setCompany((preUser) => { return { ...preUser, com_name: e.target.value } });
    }
    function handleChangeEmail(e) {
        console.log(e.target.value);
        setCompany((preUser) => { return { ...preUser, com_email: e.target.value } });
    }
    function handleChangePhone(e) {
        setCompany((preUser) => { return { ...preUser, com_phone: e.target.value } });
    }
    function handleChangeWebsite(e) {
        setCompany((precompany) => { return { ...precompany, website: e.target.value } });
    }
    function handleChangeAddress(e) {
        setCompany((precompany) => { return { ...precompany, address: e.target.value } });
    }
    function handleChangeScale(value) {
        setCompany((preStudent) => { return { ...preStudent, scale: value } });
    }
    function handleChangeYear(value) {
        setCompany((preStudent) => { return { ...preStudent, year: value } });
    }
    function handleChangeManufacture(value) {
        console.log(value);
        setCompany((preStudent) => { return { ...preStudent, manufacture: value } });
    }
    function handleChangeIntroduction(e){
        setCompany((preCompany)=>{ return {...preCompany, introduction:e.target.value}})
    }
